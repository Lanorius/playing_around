...
bg_surface = pygame.image.load('assets/background-day.png').convert() #convert allows the game to run at a faster pace, but the code would work without it
...
BIRDFLAP = pygame.USEREVENT + 1 #for every event you create you have in increase this value
